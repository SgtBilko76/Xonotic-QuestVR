...
/* (EGL context creation removed: the session binds to SDL's context, see vr_base.c) */
...
int ovrApp_HandleXrEvents(ovrApp* app) {
	XrEventDataBuffer eventDataBuffer; memset(&eventDataBuffer, 0, sizeof(eventDataBuffer));
	int recenter = 0;
