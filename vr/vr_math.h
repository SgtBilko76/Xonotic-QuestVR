/* vr_math.h - OpenXR pose/quaternion helpers (ported from CSVR engine/vr/VrMath.h) */
#pragma once
...
/* Quake angles (pitch, yaw, roll in degrees) of an OpenXR orientation, with an extra local rotation
 * (degrees, applied first - used for the weapon pitch correction) */
