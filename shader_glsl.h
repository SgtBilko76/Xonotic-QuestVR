...
"# endif\n",
#ifdef USE_GLES2
"#ifndef USEMULTIVIEW\n", // GLSL ES 3.00 has sampler3D built in, and the compiler rejects extension directives this late
...
"precision highp float;\n",
"#ifdef USEMULTIVIEW\n",
"precision mediump sampler3D;\n", // GLSL ES 3.00 has no default precision for sampler3D (lightgrid)
...
"#  ifdef USEMULTIVIEW\n",
"layout(num_views = 2) in;\n", // must follow every #extension directive
"#  endif\n",
"# endif\n",
...
"#ifdef VERTEX_SHADER\n",
"#ifdef USEMULTIVIEW\n",
"uniform highp mat4 ModelViewProjectionMatrix[2];\n",
"#define MVPMATRIX ModelViewProjectionMatrix[gl_ViewID_OVR]\n",
"#else\n",
"uniform highp mat4 ModelViewProjectionMatrix;\n",
"#define MVPMATRIX ModelViewProjectionMatrix\n",
"#endif\n",
"#endif\n",
"\n",
"#ifdef VERTEX_SHADER\n",
...
"#endif\n",
"	gl_Position = MVPMATRIX * Attrib_Position;\n",
"#ifdef USETRIPPY\n",
...
"#ifdef VERTEX_SHADER\n",
"#ifdef USEMULTIVIEW\n",
"uniform highp vec3 EyePosition[2];\n",
"#ifndef EYEPOSITION\n",
"#define EYEPOSITION EyePosition[gl_ViewID_OVR]\n",
"#endif\n",
"#else\n",
"uniform highp vec3 EyePosition;\n",
"#ifndef EYEPOSITION\n",
"#define EYEPOSITION EyePosition\n",
"#endif\n",
"#endif\n",
"uniform highp mat4 TexMatrix;\n",
"\n",
...
"#endif\n",
"#ifdef USEMULTIVIEW\n",
"uniform highp mat4 ModelViewMatrix[2];\n",
"#ifndef MVMATRIX\n",
"#define MVMATRIX ModelViewMatrix[gl_ViewID_OVR]\n",
"#endif\n",
"#else\n",
"uniform highp mat4 ModelViewMatrix;\n",
"#ifndef MVMATRIX\n",
"#define MVMATRIX ModelViewMatrix\n",
"#endif\n",
"#endif\n",
"void main(void)\n",
"{\n",
...
"#endif\n",
"\n",
"	VectorS = (MVMATRIX * vec4(Attrib_TexCoord1.xyz, 0));\n",
"	VectorT = (MVMATRIX * vec4(Attrib_TexCoord2.xyz, 0));\n",
"	VectorR = (MVMATRIX * vec4(Attrib_TexCoord3.xyz, 0));\n",
"	gl_Position = MVPMATRIX * Attrib_Position;\n",
"#ifdef USETRIPPY\n",
"	gl_Position = TrippyVertex(gl_Position);\n",
"#endif\n",
"	Depth = (MVMATRIX * Attrib_Position).z;\n",
"}\n",
"#endif // VERTEX_SHADER\n",
"\n",
"#ifdef FRAGMENT_SHADER\n",
...
"void main(void)\n",
"{\n",
"	ModelViewPosition = MVMATRIX * Attrib_Position;\n",
"	gl_Position = MVPMATRIX * Attrib_Position;\n",
"}\n",
"#endif // VERTEX_SHADER\n",
"\n",
...
"	myhalf3 ambientcolor = cast_myhalf3(dp_texture3D(Texture_LightGrid, LGTC));\n",
"	myhalf3 lightcolor = cast_myhalf3(dp_texture3D(Texture_LightGrid, LGTC + vec3(0, 0, 0.333333)));\n",
"	myhalf3 lightnormal_worldspace = cast_myhalf3(dp_texture3D(Texture_LightGrid, LGTC + vec3(0, 0, 0.6666667))) * 2.0 + cast_myhalf3(-1.0, -1.0, -1.0);\n",
